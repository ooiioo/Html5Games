declare module skins.panel{
	class RankingItemRenderSkin extends egret.gui.Skin{
	}
}
declare module skins.panel{
	class RankingPanelSkin extends egret.gui.Skin{
	}
}
declare module skins.panel{
	class ScorePanelSkin extends egret.gui.Skin{
	}
}
